...
class SettingsWindow(customtkinter.CTkToplevel):
    def __init__(self, *args, **kwargs):
        ...
        self.geometry("600x680")  # Height increased for new option
        ...
        self.create_setting_row(
            "Transifex Org Slug:", 5, "The part of your Transifex URL after '.com/'"
        )
        self.create_setting_row(
            "Transifex Project Slug:",
            6,
            "The part of your Transifex URL after your organization slug.",
        )
        ...
        # Backup Settings (row numbers shifted down)
        ...
        # Debug Settings (row numbers shifted)
        ...
        # Action Buttons (row numbers shifted)
    ...
    def save_settings(self):
        ...
        set_key("backup_enabled", "1" if self.backup_checkbox.get() == 1 else "0")
        set_key("auto_update_enabled", "1" if self.update_checkbox.get() == 1 else "0")
